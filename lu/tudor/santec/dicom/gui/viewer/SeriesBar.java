		...
		new Thread() {
			public void run() {
				...
				for (File[]  files : seriesFiles) {
				    Series s = new Series(files, imageInMemory.isSelected(), tryOpenViaImageJFirst);
