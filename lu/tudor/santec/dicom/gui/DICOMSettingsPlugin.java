...
public class DICOMSettingsPlugin extends SettingsPlugin {
	...
	private void buildPanel() {
		...
		generalPanel = createSubPanel(Translatrix
				.getTranslationString("dicom.General"));
		FormLayout generalLayout = new FormLayout(
				"55dlu, 2dlu, pref:grow, 2dlu, 40dlu, 2dlu, 20dlu, 2dlu, 30dlu",
				"pref, 2dlu, pref, 2dlu");
		generalPanel.setLayout(generalLayout);
		// add Fields for file
		generalPanel.add(this.openViaImageJ, cc.xyw(1, 1, 7));
		generalPanel.add(this.openViaImageJLabel, cc.xy(1, 3));
...
//		 build the Layout for DICOM query
		...
		dicomQueryPanel.add(this.queryOpenOnReceive, cc.xyw(3, 9, 8));
...
//		 build the Layout for DICOM header
	...
	public void revertToDefaults() {
		...
		// general
		this.openViaImageJ.setSelected(((Boolean) getDefault(TRY_OPEN_VIA_IMAGEJ))
				.booleanValue());
		...
		this.queryOpenOnReceive.setSelected(((Boolean) getDefault(QUERY_OPENONRECEIVE))
				.booleanValue());
	...
	public void setStationaryValues() {
		...
		// general
		setStationary(TRY_OPEN_VIA_IMAGEJ, new Boolean(true));
		...
		setStationary(QUERY_OPENONRECEIVE, true);
...
//		setStationary(DICOM_FIELDS,"0008,0060\n0008,1010\n0020,0013\n0018,0050\n0018,0060\n0008,0021\n0008,0031");
	...
	public void updateSettings() {
		...
		// general
		setValue(TRY_OPEN_VIA_IMAGEJ, this.openViaImageJ.isSelected());
		...
		setValue(QUERY_OPENONRECEIVE, this.queryOpenOnReceive.isSelected());
	...
	public void reflectSettings() {
		...
		try {
			...
			// general
			this.openViaImageJ.setSelected(((Boolean) getValue(TRY_OPEN_VIA_IMAGEJ)).booleanValue());
			...
			this.queryOpenOnReceive.setSelected(((Boolean) getValue(QUERY_OPENONRECEIVE))
					.booleanValue());
	...
	public void relocalize() {
		...
		setSubPanelTitle(this.generalPanel,Translatrix	.getTranslationString("dicom.General"));
		this.openViaImageJ.setText(Translatrix.getTranslationString("dicom.OpenViaImageJ"));
		...
		this.queryOpenOnReceive.setText(Translatrix.getTranslationString("dicom.OpenOnReceive"));
    	...
    	jb.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					String retVal = testPACS("PACS", DICOMSettingsPlugin.this, url);
					if (retVal == null) {
						jb.setIcon(OK);
					} else {
		...
		try {
			if (DCMEcho.sendEcho(url) == Status.Success) {
				...
				JOptionPane.showMessageDialog(parent,
					    "Connection TO "+name + " DOES NOT work!",
