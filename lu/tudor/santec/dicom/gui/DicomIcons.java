...
private static Logger logger = Logger.getLogger("lu.tudor.santec.dicom.gui.Icons");
	...
	public static final String ACTION_SR = "action_sr.png";
	public static final String ACTION_OVAL = "action_oval.png";
	public static final String ACTION_MOVEROI = "action_moveroi.png";
	public static final String ACTION_DRAWOVAL = "action_drawoval.png";
	...
	public static final String WEB = "web.png";

	public static final String WEB1 = "web1.png";
	public static final String WEB2 = "web2.png";
	public static final String WEB3 = "web3.png";
	
    public static final String NCIPHANTOM_NEWBORN = "ncict_phantom_newborn.jpg";
    public static final String NCIPHANTOM_1 = "ncict_phantom_1.jpg";
    public static final String NCIPHANTOM_5 = "ncict_phantom_5.jpg";
    public static final String NCIPHANTOM_10 = "ncict_phantom_10.jpg";
    public static final String NCIPHANTOM_15 = "ncict_phantom_15.jpg";
    public static final String NCIPHANTOM_ADULT = "ncict_phantom_adult.jpg";
    ...
    public static ImageIcon getIcon(String iconname) {
        ...
        if (imgURL != null) {
            ...
            logger.warn("Missing Icon: " + iconpath + iconname);
        }
        return null;
    }
