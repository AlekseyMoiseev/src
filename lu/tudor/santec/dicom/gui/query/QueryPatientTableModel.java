...
public class QueryPatientTableModel extends AbstractTableModel {
	...
	private String[] columns = {
			...
			Translatrix.getTranslationString("dicom.PatientBirthdate"),
			Translatrix.getTranslationString("dicom.PatientSex")
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		case 2:
			try {
				return df.format(dr.getDate(Tag.PatientBirthDate));				
			} catch (Exception e) {
				return dr.getString(Tag.PatientBirthDate);
			}
		case 3:
			return dr.getString(Tag.PatientSex);
		default:
			return null;
		}
	}
