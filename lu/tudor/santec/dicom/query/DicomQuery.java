...
//        query.addReturnKey(Tag.InstanceCreationTime);
     ...
     */
    public void moveSeries(Component parent, String destUrl, DicomObject series)
	    throws Exception {
	try {
	    progressMonitor = new ProgressMonitor(parent,
		    "Moving Series to AET: \r\n" + destUrl, "moving.....", 0, 3);
     ...
     * @exception  Exception  Description of the Exception
     */
    public void moveStudies(Component parent, String destUrl, DicomObject study)
	    throws Exception {
	try {
	    progressMonitor = new ProgressMonitor(parent,
		    "Moving Studies to AET: \r\n" + destUrl, "moving.....", 0, 3);
	    progressMonitor.setMillisToDecideToPopup(0);
	    progressMonitor.setMillisToPopup(0);
     ...
     * @exception  Exception  Description of the Exception
     */
    public void moveImage(Component parent, String destUrl, DicomObject image)
	    throws Exception {
